...
const projects = [
  {
    title: "Switch Digital Social Media Management",
    desc: "Full-service social media management for Switch Digital across Facebook, Instagram, and YouTube driving brand growth, content strategy, and community engagement.",
    tags: ["Social Media Management", "Content Strategy", "Brand Growth", "Community Engagement", "Multi-Platform Growth"],
    links: [
      { platform: "Facebook",  url: "https://web.facebook.com/SwitchDigitalOfficial", color: "#1877f2" },
      { platform: "Instagram", url: "https://www.instagram.com/switchdigitalofficial", color: "#e1306c" },
      { platform: "YouTube",   url: "https://youtube.com/@switchdigitalofficial",      color: "#ff0000" },
    ],
  },
  {
    title: "RCCG Jeth Family Social Media Management",
    ...
    tags: ["Social Media Management", "Content Strategy", "Community Relations", "Multi-Platform Growth"],
    links: [
      { platform: "Facebook",  url: "https://www.facebook.com/share/1EHXw3nDD1/",    color: "#1877f2" },
      { platform: "Instagram", url: "https://www.instagram.com/rccgjethfamily",       color: "#e1306c" },
      { platform: "YouTube",   url: "https://youtube.com/@rccgjethfamily",            color: "#ff0000" },
    ],
  },
  {
...
const FB = () => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
    <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047v-2.66c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97h-1.513c-1.491 0-1.956.93-1.956 1.885v2.266h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"/>
  </svg>
);
...
const platformIcon = { Facebook: <FB />, Instagram: <IG />, YouTube: <YT /> };
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .proj-link  { display:inline-flex; align-items:center; gap:6px; border:1px solid; border-radius:8px; padding:5px 12px; font-size:12px; font-weight:600; text-decoration:none; opacity:.85; transition:opacity .2s; }
        ...
        @media (max-width:940px) {
          .hero       { overflow:visible; align-items:flex-start; min-height:auto; padding:110px 20px 70px; }
          .hero-grid  { grid-template-columns:1fr; gap:52px; }
          .img-col    { order:-1; max-width:380px; margin:0 auto; width:100%; }
          .img-box img, .img-fb { max-height:430px; }
          .nav-row    { flex-wrap:wrap; gap:12px; padding:18px 20px; }
          ...
          .sec        { padding:70px 0; }
          .sec-alt    { padding:70px 0; }
          .cta-sec    { padding:70px 0; }
        }

        /* ── small mobile ── */
        @media (max-width:540px) {
          .hero       { padding:96px 14px 50px; min-height:auto; align-items:flex-start; }
          .wrap       { padding:0 14px; }
          .nav-row    { padding:14px; }
          .mob-menu   { padding:18px 14px 24px; width:100%; }
          .hero-grid  { gap:28px; }
          .img-col    { max-width:100%; }
          .img-box    { width:100%; }
          .img-box img, .img-fb { max-height:340px; }
          .img-card   { position:static; margin-top:16px; }
          .hero-sub   { max-width:100%; }
          .stats      { gap:18px; flex-wrap:wrap; }
          .stat-n     { font-size:32px; }
          .hero-btns  { flex-direction:column; }
          .btn-primary,.btn-ghost,.btn-wa,.btn-email,.btn-call,.btn-li { width:100%; justify-content:center; }
          .foot-row   { flex-direction:column; align-items:center; text-align:center; }
          .cta-row    { flex-direction:column; align-items:center; }
          .cta-row a  { width:100%; justify-content:center; }
          .proj-grid  { grid-template-columns:1fr; }
          .sec        { padding:48px 0; }
          .sec-alt    { padding:48px 0; }
          .cta-sec    { padding:48px 0; }
          .sec-p      { margin-bottom:32px; font-size:15px; }
          .edu-card   { padding:18px 16px; gap:14px; }
          .quote      { padding-left:18px; font-size:16px; }
        ...
        @media (max-width:390px) {
          ...
          .img-box img, .img-fb { max-height:300px; }
          .logo       { font-size:16px; }
        }
                    ...
                    <div className="proj-links">
                      {project.links.map(link => (
                        <a key={link.platform} href={link.url} target="_blank" rel="noopener noreferrer"
                          className="proj-link" style={{ borderColor: link.color, color: link.color }}>
